 ...
 */
final class Version20200520041427 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE filtrage (id INT AUTO_INCREMENT NOT NULL, roles JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('DROP TABLE contact');
        $this->addSql('ALTER TABLE bloquer CHANGE agent agent VARCHAR(255) DEFAULT NULL, CHANGE value value VARCHAR(255) DEFAULT NULL, CHANGE netfunnel netfunnel VARCHAR(255) DEFAULT NULL, CHANGE closing_date closing_date VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE bloquer_client ADD user_id INT NOT NULL');
