 ...
 */
final class Version20200524195211 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bloquer CHANGE agent agent VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE commande ADD autre VARCHAR(255) NOT NULL, CHANGE typ_de_panne typ_de_panne VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE prospect ADD pourcentage_avan VARCHAR(255) NOT NULL, CHANGE etat etat VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bloquer CHANGE agent agent VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE commande DROP autre, CHANGE typ_de_panne typ_de_panne VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE prospect DROP pourcentage_avan, CHANGE etat etat VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
