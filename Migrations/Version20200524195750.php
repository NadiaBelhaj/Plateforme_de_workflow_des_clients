 ...
 */
final class Version20200524195750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bloquer ADD pourcentage_avan VARCHAR(255) NOT NULL, CHANGE agent agent VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bloquer DROP pourcentage_avan, CHANGE agent agent VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
