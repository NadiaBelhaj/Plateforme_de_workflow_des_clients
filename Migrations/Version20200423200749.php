 ...
 */
final class Version20200423200749 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD backgrouncolor VARCHAR(255) NOT NULL, ADD textcolor VARCHAR(255) NOT NULL, ADD bordercolor VARCHAR(255) NOT NULL, ADD nomurl VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP backgrouncolor, DROP textcolor, DROP bordercolor, DROP nomurl');
