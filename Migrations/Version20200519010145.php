 ...
 */
final class Version20200519010145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bloquer CHANGE agent agent VARCHAR(255) NOT NULL, CHANGE value value VARCHAR(255) NOT NULL, CHANGE netfunnel netfunnel VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE company company VARCHAR(255) NOT NULL, CHANGE mail mail VARCHAR(255) NOT NULL, CHANGE phone phone VARCHAR(255) NOT NULL, CHANGE state state VARCHAR(255) NOT NULL, CHANGE reminder reminder VARCHAR(255) NOT NULL, CHANGE adresse adresse VARCHAR(255) NOT NULL, CHANGE siteweb siteweb VARCHAR(255) NOT NULL, CHANGE closing_date closing_date VARCHAR(255) NOT NULL, CHANGE contact_name contact_name VARCHAR(255) NOT NULL, CHANGE contact_position contact_position VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE bloquer_user CHANGE roles roles JSON NOT NULL, CHANGE activation_token activation_token VARCHAR(255) DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE client ADD user_id_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE commande CHANGE typ_de_panne typ_de_panne VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE prospect CHANGE agent agent VARCHAR(255) NOT NULL, CHANGE value value VARCHAR(255) NOT NULL, CHANGE netfunnel netfunnel VARCHAR(255) NOT NULL, CHANGE closing_date closing_date VARCHAR(255) NOT NULL, CHANGE reminder reminder VARCHAR(255) NOT NULL, CHANGE adresse adresse VARCHAR(255) NOT NULL, CHANGE siteweb siteweb VARCHAR(255) NOT NULL, CHANGE etat etat VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE filtrage CHANGE roles roles VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE prospect CHANGE agent agent VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE value value VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE netfunnel netfunnel VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE closing_date closing_date VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE reminder reminder VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE adresse adresse VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE siteweb siteweb VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE etat etat VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE search CHANGE name name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
